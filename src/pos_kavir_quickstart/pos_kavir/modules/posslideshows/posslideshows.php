        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1" data-animation="animated fadeInDown">The better smoking choice</p>
					<p class="title2" data-animation="animated fadeInRight">make the switch today</p>
					<p class="readmore" data-animation="animated fadeInUp"><a href="#"><span>Shop now</span></a></p>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc2">
					<p class="title1" data-animation="animated fadeInLeft">STAR SERIES</p>
					<p class="title2" data-animation="animated fadeInRight">FOR HIGH QUALITY AND LIFE ENJOYMENT</p>
					<p class="readmore" data-animation="animated fadeInUp"><a href="#"><span>Shop now</span></a></p>
					</div>';
				}else{
