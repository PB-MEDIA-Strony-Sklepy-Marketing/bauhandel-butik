...
class PosSpecialProducts extends Module implements WidgetInterface{
	...
	public function __construct() {
		...
		$this->bootstrap = true;
		$this->_html        = '';
		$this->displayName 	= $this->l('Pos Speical Products module');
	...
	public function install() {
        ...
        Configuration::updateValue($this->name . '_per_sm', 1);
	...
	{	
		...
		$values['posspecialproducts_title'][(int)$id_lang] = 'SPECIAL PRODUCTS';
