...
class postabcateslider extends Module implements WidgetInterface {
	...
	public function install() {
        ...
        Configuration::updateValue($this->name . '_number_item', 5);
	...
	{	
		...
		$values['postabcateslider_title'][(int)$id_lang] = 'Our products';
    ...
    {	 
        if (!$this->isCached($this->templateFile, $this->getCacheId('postabcateslider'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('postabcateslider'));
    }
